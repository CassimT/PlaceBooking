    ...
    <div className="flex flex-col items-center w-full">
      <div className=" w-10/12 p-10">
        <div style= {{backgroundImage: `url(${imagePath})`}}className="mx-auto px-4 w-full h-96 shadow-2xl rounded-3xl  flex flex-col justify-start items-start p-10 bg-cover">
          ...
          <div className="text-2xl font-semibold font-serif text-white">We are here to give you a Fast,Simple and Secure way to</div>
          <div className="text-2xl font-semibold font-serif text-white">find accommodation during your studies.</div>
          <div></div>
              <div className="text-2xl font-serif font-bold text-white">Secure your spot today!</div>
          </div>
        </div>
      </div>
